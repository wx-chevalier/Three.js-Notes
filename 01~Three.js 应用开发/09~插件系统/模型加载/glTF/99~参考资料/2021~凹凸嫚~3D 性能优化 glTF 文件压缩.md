...
![glTF JSON 文件格式](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307105457.png)
...
![自包含](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112441.png)

- 引用外部二进制和纹理资源的：

![外部资源](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112513.png)

### 2.2.2 .gltf 文件预览

- 自包含的：

![自包含](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112542.png)

- 引用外部二进制和纹理资源：

![引用外部资源](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112608.png)

### 2.2.3 glb 文件预览

- 自包含的：

![GLB 自包含](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112647.png)

- 引用外部二进制和纹理资源：

![引用二进制与纹理资源](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112711.png)
...
![拆分出来的文件](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112931.png)

再回顾一下，.glb 文件是这么引入外部单独的纹理与二进制文件的：

![拆分文件](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307112957.png)
...
![性能对比](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307113100.png)

# 四、glTF 文件压缩

如上面介绍，glTF 文件包括.gltf/.glb 文件、.bin 文件以及纹理资源。glTF2.0 相关的插件主要有以下：

![glTF 2.0 插件](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307113214.png)
...
![请求对比](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307113530.png)

所以，如果一个项目需要加载多个 glTF 文件，那么可以创建一个 DRACOLoader 实例并重复使用它。但如果项目只需要加载一个 glTF 文件，那么使用 draco 算法是否具有“性价比”就值得考量了。

![性能对比](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307113610.png)
...
![模型图片](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307141253.png)
...
![性能对比](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307141830.png)
...
![性能对比](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/20230307142435.png)
