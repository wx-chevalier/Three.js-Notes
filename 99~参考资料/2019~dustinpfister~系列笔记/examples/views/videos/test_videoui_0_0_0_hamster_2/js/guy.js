(function (GuyMod) {
  ...
  GuyMod.create = function () {
    ...
    // HEAD
    guy.head = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), materials_head);
    ...
    // BODY
    guy.body = new THREE.Mesh(new THREE.BoxGeometry(1, 2, 1), material_body);
    ...
    guy.arm_right.geometry.translate(0, -0.5, 0);
    guy.arm_right.position.x = 1;
    guy.arm_right.position.y = 0.75;
    ...
    guy.arm_left.geometry.translate(0, -0.5, 0);
    guy.arm_left.position.x = -1;
    guy.arm_left.position.y = 0.75;
  ...
  GuyMod.moveLegs = function (guy, per) {
    ...
    guy.leg_left.rotation.set(0.75 - bias * 1.5, 0, 0);
    guy.leg_right.rotation.set(-0.75 + bias * 1.5, 0, 0);
  };
  // walk
  GuyMod.walk = function (guy, per, swings) {
    ...
    GuyMod.moveArm(guy, "arm_right", -0.1 + 0.2 * armPer, 0);
    GuyMod.moveArm(guy, "arm_left", 0.1 - 0.2 * armPer, 0);
